...
<div class="container-fluid">
	...
	<form class="form-horizontal" role="form" method="POST" action="/validated/photos/create-photo?id={{$id}}" enctype="multipart/form-data">
		...
		<div class="form-group required">
			...
			<div class="col-md-6">
				<textarea type="text" class="form-control" name="description" rows="3" required>{{old('desription')}}</textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<a href = "/validated/photos?id={{$id}}" class="btn btn-danger">Cancel</a>			
		</div>
